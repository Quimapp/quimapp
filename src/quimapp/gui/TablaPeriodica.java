...
public class TablaPeriodica extends JPanel implements ActionListener, MouseListener {

    private JButton H, Li, Na, K, Rb, Cs, Fr, Co, Rh, Ir, Mt, O, S, Se, Te, Po, Uuh, Be, Mg, Ca, Sr, Ba, Ra, Ni, Pd, Pt, Ds, F, Cl, Br,
...
//        ventana.add(new TablaPeriodica());
...
//    }
    ...
    public void hoverButton(JButton btn) {
